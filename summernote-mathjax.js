    ...
    $.extend(true, $.summernote.lang, {
        "en-US": {
            ...
            math: {
                ...
                ok: "Insert",
                cancel: "Cancel",
                inputTitle: "Type Latex markup here: ",
        ...
        "math": function(context) {
            ...
            self.initialize = function() {
                ...
                let body = `<div class="form-group">
                    <p>`+lang.math.inputTitle+`</p>
                    <p><input id="note-latex" class="form-control"></p>
                    <p>`+lang.math.inputPreview+`</p>
                    <div style="min-height:20px;"><span id="note-mathjax-preview" class="note-mathjax-preview"></span></div>
                    <script>
                        let intput = document.getElementById("note-latex");
                        intput.addEventListener("keyup", renderMath);
            
                        function renderMath() {
                            var input = document.getElementById("note-latex").value.trim();
                            output = document.getElementById("note-mathjax-preview");
                            output.innerHTML = "";
            
                            MathJax.texReset();
                            var options = MathJax.getMetricsFor(output, false);
            ...
            self.show = function() {
                let $mathSpan = self.$dialog.find(".note-mathjax-preview");
                ...
                self.showMathDialog().then(function() {
                    ...
                    $mathNodeClone.removeClass("note-mathjax-preview").addClass("note-math");
